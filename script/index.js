const menu = [
    ...
    {image: "./assets/dishes/sandwich.jpeg", optionTitle: "Sandu. de abacate", description: "sanduíche de abacate feito com tempero super especial", price: "6,50", priceId: 6.50, function: "selectDishes", idOption: "food-option", idTitle: "food-title", idPrice: "food-price"}
    ],
    ...
    {image: "./assets/drinks/passion-fruit-juice.png", optionTitle: "Suco de Maracujá", description: "feito com maracujá bem gelado", price: "3,80", priceId: 3.80, function: "selectDrinks", idOption: "food-option", idTitle: "food-title", idPrice: "food-price"},
    ...
    {image: "./assets/dessert/italian-fudge.jpeg", optionTitle: "Palha Italiana", description: "palha italiana macia e muito bem recheada", price: "6,70", priceId: 6.70, function: "selectDesserts", idOption: "food-option", idTitle: "food-title", idPrice: "food-price"}
    ]   
];
...
function sendOrder() {
    ...
    window.open(`https://wa.me/55(45)3843-8777?text=${encodeURIComponent(`Olá, gostaria de fazer o pedido:\n- Prato: ${dishTitle}\n- Bebida: ${drinkTitle}\n- Sobremesa: ${dessertTitle} \nTotal: R$ ${totalPrice.toFixed(2)}\n\nNome: ${userName}\nEndereço: ${userAddress}`)}`).focus;
}
